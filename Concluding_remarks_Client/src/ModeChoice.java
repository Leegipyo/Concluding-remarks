...
public class ModeChoice extends JFrame {
	...
	public ModeChoice() {
		...
		JButton btn싱글 = new JButton("싱글");
		btn싱글.setBounds(112, 198, 97, 169);
...
//				setVisible(false);
		...
		JButton btn멀티 = new JButton("멀티");
		btn멀티.setBounds(332, 198, 97, 169);
...
//				System.out.println("입장 유저: " + Client.list.toString());
		...
		JButton btn모드선택_뒤로가기 = new JButton("뒤로가기");
		btn모드선택_뒤로가기.setBounds(475, 528, 97, 23);
